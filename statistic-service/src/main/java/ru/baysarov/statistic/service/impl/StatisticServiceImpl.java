...
/**
 * Реализация сервиса статистики, предоставляющего отчеты о затраченном времени и статистику по
 * статусам задач.
 */
@Service
...
public class StatisticServiceImpl implements StatisticService {
   ...
   */
  @Override
  public ByteArrayInputStream timeSpentReport(String userEmail, LocalDate startDate,
      LocalDate endDate, boolean isManager) {
    if (startDate == null) {
